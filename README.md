...
- **Carter Yang** — Developed the front-end visualization interface for segmented and registered CT outputs, and the image registration pipline.
- **Sani Hasan** — Implemented the core codebase for segmentation pipline and developed the 3D reconstruction pipeline.
